 ...
 * @author Vimal
 */
public class AuthenticationAdd extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AuthenticationAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
